 ...
 */
@WebServlet("/ExecuteShowUtenteServlet")
public class ExecuteShowUtenteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Utente utenteInstance = utenteService.caricaSingoloEager(Long.parseLong(idUtenteParam));
			...
			request.setAttribute("utente_list_attribute", utenteInstance);
		} catch (Exception e) {
			// qui ci andrebbe un messaggio nei file di log costruito ad hoc se fosse attivo
			e.printStackTrace();
			request.setAttribute("errorMessage", "Attenzione si è verificato un errore.");
